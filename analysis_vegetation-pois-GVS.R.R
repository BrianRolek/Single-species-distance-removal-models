...
load("/scratch/brolek/ch2/Data/global_est_veg.Rdata")
...
#,file="V14.txt")
#i <- 1
for (i in c(17,18,19)){ #Skip spp c(10,3,5,2) use ZIPs
  try(rm("out"))
  spp <- spp.list.foc[i]
  ...
  fn<- paste( "/scratch/brolek/ch2/outputs/veg_global_GVS_", spp, ".RData", sep="" )
